...
public class MinimapIcon : NetworkBehaviour
{
    ...
    void Start()
    {
        // Cr�ation ic�nes pour objets non joueurs
    ...
    {
        // Cr�er ic�ne quand c'est le joueur local
        if (iconType == IconType.Player)
            TryCreateIcon();
    }
    ...
    {
        // Cr�er un child GameObject pour l'ic�ne
    ...
    void LateUpdate()
    {
        if (iconObject != null)
        {
            // D�calage en hauteur pour �tre visible sur la minimap
