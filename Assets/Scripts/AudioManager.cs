...
// Gestionnaire audio global persistant entre les sc�nes (musique de fond +  volume des effets sonores)
public class AudioManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Initialiser les AudioSources si non assign�es
    ...
    private void Start()
    {
        // Jouer la musique du menu au d�marrage
        PlayMenuMusic();
    }
    ...
    {
        // Cr�er les AudioSources s'ils n'existent pas
        if (musicSource == null)
        {
    ...
    public void PlayMenuMusic()
    {
        if (menuMusic != null && musicSource.clip != menuMusic)
        {
            ...
            musicSource.Play();
            Debug.Log("AudioManager: Musique menu lanc�e");
        }
    }
    ...
    public void PlayGameMusic()
    {
        ...
        if (gameMusic != null)
        {
            // Il y a une musique de jeu assign�e = la jouer
            if (musicSource.clip != gameMusic)
            {
                musicSource.clip = gameMusic;
            }
            musicSource.Play();
            Debug.Log("AudioManager : musique de jeu lanc�e");
        }
        else
        {
            // Pas de musique de jeu assign�e = silence total
            musicSource.clip = null;
            Debug.Log("AudioManager: pas de musique de jeu assign�e, musique stopp�e");
        }
    }
